    ...
    <div class="nav-container">
      ...
      <a class="nav-item center-nav" routerLink="/dashboard" routerLinkActive="active">
        <div class="center-circle">
          <img src="assets/images/icone-manuderma@2x.png" alt="Home">
        </div>
      </a>
...
`;
fs.writeFileSync('/Users/gginer/Documents/Manuderma/Leo-Pharma/src/app/components/bottom-nav/bottom-nav.component.ts', tsCode, 'utf8');